...
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiInStoreClient;
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiInStoreService;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(InStoreActivity.this,
...
//
        pDialog = new ProgressDialog(InStoreActivity.this,
            ...
            userCall.enqueue(new Callback<InstoreResponse>() {
                ...
                public void onResponse(Call<InstoreResponse> call, retrofit2.Response<InstoreResponse> response) {
                    ...
                    if (response.body().getSuccess() == 1) {
                        Toast.makeText(InStoreActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();

                        AlertDialog.Builder builder = new AlertDialog.Builder(InStoreActivity.this, R.style.MyDialogTheme);
...
//                                    intent.putExtra("telephone",telephonee);
                        ...
                        Toast.makeText(InStoreActivity.this, "Failed to Save" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onFailure(Call<InstoreResponse> call, Throwable t) {
                    hidepDialog();

                    Toast.makeText(InStoreActivity.this, "Failed to Save" , Toast.LENGTH_LONG).show();
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(InStoreActivity.this).
...
//            String commentss = comments.getText().toString();
//            String routie = routess;
//            String lunchtime = this.lunchtime.getText().toString();
//
//
//            ApiInStoreService service = ApiInStoreClient.getClient().create(ApiInStoreService.class);
//            //User user = new User(name, email, password);
//
//
//            Call<DetailsOneResponse> userCall = service.sendRegister(openingstockk, closingstockk, commentss, routie,lunchtime, lat, lon);
//
