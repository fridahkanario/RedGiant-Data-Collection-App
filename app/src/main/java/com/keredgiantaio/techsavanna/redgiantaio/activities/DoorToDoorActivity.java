...
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiDoorToDoorService;
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiDoorToDoorClient;
...
//Door to door sampling activities.     // for the BAs who are doing door to door
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(DoorToDoorActivity.this,
...
//
        pDialog = new ProgressDialog(DoorToDoorActivity.this,
            ...
            userCall.enqueue(new Callback<DoortoDoorResponse>() {
                ...
                public void onResponse(Call<DoortoDoorResponse> call, retrofit2.Response<DoortoDoorResponse> response) {
                    ...
                    if (response.body().getSuccess() == 1) {
                        Toast.makeText(DoorToDoorActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();

                        AlertDialog.Builder builder = new AlertDialog.Builder(DoorToDoorActivity.this, R.style.MyDialogTheme);
                        ...
                        builder.setPositiveButton(Html.fromHtml("<font color='orange'>Ok</font>"),
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        Intent intent = new Intent(DoorToDoorActivity.this, DashboardActivity.class);
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(DoorToDoorActivity.this).
