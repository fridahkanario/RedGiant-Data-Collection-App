...
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiMarketStormClient;
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiMarketStormService;
...
//Market storm activities
public class MarketStormActivity extends AppCompatActivity implements ConnectionCallbacks,
        OnConnectionFailedListener, LocationListener {
    private Spinner routes;
    EditText openingstock, closingstock, comments,outletname, baname;;
    String routess;
    List<String> list;
    String question;
    Button btnlogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_market_storm);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(MarketStormActivity.this,
...
//
        pDialog = new ProgressDialog(MarketStormActivity.this,
        ...
        if (location != null) {
            ...
            String campaign = "Market Storm";
            SharedPreferences prefs = getSharedPreferences("MyApp", MODE_PRIVATE);
            String id_user  = prefs.getString("telephone", "UNKNOWN");

            ApiMarketStormService service = ApiMarketStormClient.getClient().create(ApiMarketStormService.class);
            //User user = new User(name, email, password);


            Call<MarketStormResponse> userCall = service.sendRegister(banames,outletnames,openingstockk, closingstockk, commentss, routie, campaign,id_user,lat, lon);

            System.out.println("data outing" + openingstockk + " " + closingstockk + " " + commentss + " " + " " + routie + " " + lat + " " + lon);
            userCall.enqueue(new Callback<MarketStormResponse>() {
                @Override
                public void onResponse(Call<MarketStormResponse> call, retrofit2.Response<MarketStormResponse> response) {
                    // hidepDialog();
                    //onSignupSuccess();
                    ...
                    if (response.body().getSuccess() == 1) {
                        Toast.makeText(MarketStormActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();

                        AlertDialog.Builder builder = new AlertDialog.Builder(MarketStormActivity.this, R.style.MyDialogTheme);
                        ...
                        builder.setPositiveButton(Html.fromHtml("<font color='orange'>Ok</font>"),
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        Intent intent = new Intent(MarketStormActivity.this, DashboardActivity.class);
...
//                                    intent.putExtra("telephone",telephonee);
                ...
                @Override
                public void onFailure(Call<MarketStormResponse> call, Throwable t) {
                    hidepDialog();
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(MarketStormActivity.this).
