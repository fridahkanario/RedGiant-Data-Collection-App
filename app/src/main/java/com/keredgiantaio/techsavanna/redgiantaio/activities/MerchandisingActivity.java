...
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiMerchandisingClient;
import com.keredgiantaio.techsavanna.redgiantaio.helpers.ApiMerchandisingService;
...
public class MerchandisingActivity extends AppCompatActivity implements ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instock = findViewById(R.id.input_in_stock);
        outofstock = findViewById(R.id.input_out_of_stock);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(MerchandisingActivity.this,
...
//
        pDialog = new ProgressDialog(MerchandisingActivity.this,
            ...
            userCall.enqueue(new Callback<MerchandisingResponse>() {
                ...
                public void onResponse(Call<MerchandisingResponse> call, retrofit2.Response<MerchandisingResponse> response) {
                    ...
                    if (response.body().getSuccess() == 1) {
                        Toast.makeText(MerchandisingActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();

                        AlertDialog.Builder builder = new AlertDialog.Builder(MerchandisingActivity.this, R.style.MyDialogTheme);
                        ...
                        builder.setPositiveButton(Html.fromHtml("<font color='orange'>Ok</font>"),
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        Intent intent = new Intent(MerchandisingActivity.this, DashboardActivity.class);
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(MerchandisingActivity.this).
