...
import com.keredgiantaio.techsavanna.redgiantaio.methods.VolleyMultipartRequest;
    ...
    private void uploadBitmap(final Bitmap bitmap) {
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, AppConfig.UPLOAD_URL,
                new Response.Listener<NetworkResponse>() {
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            Intent intent=new Intent(RegisterPictureActivity.this,FirstPageActivity.class);
                            startActivity(intent);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("nameperson", nameperson);
